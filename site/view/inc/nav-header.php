...
.icon-standard img {
    ...
    left: 5px;
                ...
                <div id="header">
                    ...
                    <div id="header-2">
                        <!-- LOGIN BAR -->
                        <div style="width:100%;min-width:350px;" id="header-2-top"
                            class="d-flex justify-content-between">
                            <button onclick="location.href='../trang-chu/'" class="btn-blank icon-standard"><img
                                    src="../../../public/img/favicon.png" alt="logo"></button>
                            <div>
                                <button onclick="location.href='../trang-ca-nhan/'"
                                    class="btn-blank icon-standard log"><i class="bi bi-person-circle"></i></button>
                                <button onclick="location.href='../trang-thanh-toan/'"
                                    class="btn-blank icon-standard log"><i class="bi bi-cart"></i></button>
                                <button onclick="openSlide()" class="btn-blank icon-standard" id=""><i
